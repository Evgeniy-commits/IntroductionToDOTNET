...
namespace Arrays
{
	internal class Program
	{
		static void Main(string[] args)
		{
			...
			Console.WriteLine($"AVG элементов массива: {arr.Cast<int>().Average()}");
			...
			Console.WriteLine($"AVG элементов массива: {(double)sum/count}");
